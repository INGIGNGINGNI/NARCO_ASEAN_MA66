<footer class="pt-4 border-top bg-main">
    <div class="row container mt-50 mb-40">
        ...
        <div class="col-lg-3 col-md-4 col-sm-12 col-12 p-3 d-flex align-items-end">
            <br><br><br>
            <iframe
        ...
        <div class="col-lg-6 col-md-4 col-sm-12 col-12 p-3">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-12 px-1">
                    <ul class="list-unstyled">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-12 px-1">
                    <ul class="list-unstyled">
                        <div class="menu-footer mb-2">
                            <li><a class="font-footer" href="#">&nbsp;&nbsp;ข้อมูล ปปส.อาเซียน</a></li>
                        </div>
                        <div class="menu-footer mb-2">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-12 comfooter p-0">
