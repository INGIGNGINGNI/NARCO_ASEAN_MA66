            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-12 px-3">
                    <ul class="list-unstyled">
                        ...
                        <div class="menu-footer mb-2">
                            <li><a class="text-white text-hover" href="#">&nbsp;&nbsp;โครงการสำคัญ</a></li>
                        </div>
                        <div class="menu-footer mb-2">
                            <li><a class="text-white text-hover" href="#">&nbsp;&nbsp;ข่าวสาร</a></li>
                        </div>
                    </ul>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-12 px-3">
                    <ul class="list-unstyled">
                        ...
                        <div class="menu-footer mb-2">
                            <li><a class="text-white text-hover" href="#">&nbsp;&nbsp;รายงานเฝ้าระวังยาเสพติด</a></li>
                        </div>
                        <div class="menu-footer mb-2">
                            <li><a class="text-white text-hover" href="#">&nbsp;&nbsp;ติดต่อเรา</a></li>
                        </div>
                    </ul>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-12 px-3">
                    <ul class="list-unstyled">
                        ...
                        <div class="menu-footer mb-2">
                            <li><a class="text-white text-hover" href="#">&nbsp;&nbsp;รายงาน</a></li>
                        </div>
                    </ul>
                </div>
            </div>
